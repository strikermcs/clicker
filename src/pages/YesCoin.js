...
const Plutos = () => {
  ...
  const { balance, tapBalance, openInfoTwo, setOpenInfoTwo, energy, battery, tapGuru, mainTap, setIsRefilling, refillIntervalRef, refillEnergy, setEnergy, tapValue, setTapBalance, setBalance, refBonus, level, loading } = useUser();
