  ...
  return (
   ...
   <span className="font-medium tapguru2">{fullTank}/3</span>
            ...
            <div
              ...
              } absolute bottom-0 left-0 right-0 h-fit bg-modal z-[100] rounded-tl-[20px] rounded-tr-[20px] flex justify-center px-4 py-5`}
            >
              ...
              <button
                ...
                <div className="w-full flex justify-center flex-col items-center">
                  <div className="w-[120px] h-[120px] rounded-[25px] bg-modalImage flex items-center justify-center">
                  ...
                  Increase amount of YESCOIN you can earn per one tap <br/>
